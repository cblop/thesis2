...
% \end{enumerate}
\deleted{2.1: Removed reference to ``character freedom'' goals from original
  literature review}

This chapter describes the use of \emph{Social Institutions} (also referred to as
\emph{Institutions} or \emph{Normative Frameworks}) to implement trope
descriptions in TropICAL in a multi-agent system. An institution is a
...
\changed{
This chapter begins by describing a scene from ``Punch and Judy'' as a set of norms in an institution in
\Fref{sec:norms-and-institutions}. \Fref{sec:punchjudy} describes
