...
Section~\Fref{sec:pj-fullspec} describes how the full Punch and Judy story world
...
\begin{lstlisting}[showstringspaces=false,
label=lst:pjfull-narratoragent,caption={AgentSpeak code for the ``Hero'' role}]
