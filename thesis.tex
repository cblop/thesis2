...
clause is empty, then the clause is a fact rather than a rule. This is the
...
An answer set is the minimal set of atoms that satisfy the rules of the
program. These atoms only appear in the answer set if a rule or fact from the program
