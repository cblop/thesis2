...
\ref{sec:instal-obl} on page~\pageref{sec:instal-obj} explains in detail how obligations, deadlines and
...
\Fref{sec:pjexample-insts}, we create an institution out of the scene we
...
\Fref{sec:pjexample} in terms of tropes, using this one piece of the
