...
\label{eq:einst-hero}
\end{align}
\caption{External and institutional events ($\mathcal{E}$) for the sausages scene} trope} \label{fig:events}
\end{figure}
