...
Section~\ref{sec:sb-eval}. Next, a validation of the TropICAL language is
described through a complete description of a Punch and Judy story in
Section~\ref{sec:pj-fullspec}. A discussion on how tropes are combined together
is in Section~\ref{sec:trope-combination-exp}, and the chapter concludes with an
examination of the extent to which ``character freedom'' has been achieved, and
the potential benefits of this, in Section~\ref{sec:freedom-example}.
...
Section~\ref{sec:planner-systems}, noting the similarities and comparative
benefits and drawbacks our approach provides. Next follows a discussion in
Section~\ref{sec:discussion-freedom} of the extent of ``character freedom'' our
