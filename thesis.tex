...
\begin{enumerate}[{I}1.]
  ...
  \item \textbf{Event Semantics}
  \item \textbf{Other Types of Entities}
  \item \textbf{Better Control Over Story Structure}
  \item \textbf{Conditionals}
\end{enumerate}
...
\subsubsection{Authoring Character Agent Behaviour}
\label{sec:future-agent-behaviour}
...
Due to the fact that tropes describe patterns of behaviour, the concept can be
