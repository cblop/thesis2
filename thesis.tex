...
}{2.4.2: Brief Introduction to InstAL}

\subsection{Why use ASP and InstAL?}
\label{sec:why-asp-instal}
\added{}{2.4.2: Explanation of why ASP and InstAL were chosen}
...
}{2.3.3: Added a discussion on how to combine tropes}
...
\changed{}{Moved this back here from its previous position in
  Ch.\ref{cha:institutions}, as this is now the first mention of P\&J}
...
\subsection{Compiling the Code to InstAL}

\subsection{Common Agent Code}
\subsubsection{Movement}
\subsubsection{Emotions}
% Include emotions that make a character ``desperate''
...
govern the agents of a Multi-Agent System.

\subsection{Code for Character Roles}
% A character role's ``sphere of action'' consists of everything they are
% permitted / obliged to do in \emph{all} of the tropes in the library
...
\subsubsection{The Director's Plans}
...
\paragraph{Answer sets: 6}
\paragraph{Time taken: 4442 msecs}
...
\paragraph{Answer sets: 3}
\paragraph{Time taken: 670 msecs}
...
\paragraph{Answer sets: 6}
\paragraph{Time taken: 1153 msecs}
...
\paragraph{Answers sets: 11}
\paragraph{Time taken: 6643 msecs}
...
\paragraph{Answer sets: 6}
\paragraph{Time taken: 1681 msecs}
...
\paragraph{Answer sets: 61}
\paragraph{Time taken: 7979 msecs}
...
\paragraph{Answer sets: 109}
\paragraph{Time taken: 13289 msecs}
...
\paragraph{Answer sets: 69}
\paragraph{Time taken: 10849 msecs}
...
\paragraph{Answer sets: 125}
\paragraph{Time taken: 34696 msecs}
...
\paragraph{Answer sets: > 500}
\paragraph{Time taken: 156772 msecs}
